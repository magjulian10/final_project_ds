...
The pacages we used are the `tidyverse` and `ggplot2`
...
We have found out that it doesn’t matter what type of song you make you have at about the same chance of being in the top 100. We came to this conclusion because, the data we have presented has shown it does a small effect if an artist includles lyrics like "girl or "baby" collaborates with others or if they use words like “baby” to make their song rise to the top. It truly depends on what the people like most at the moment. 
